 ...
 *
 * 7-2-3. difference from regular function(일반 함수와 차이점)
 *
 */
...
// const man = Man('김옥녀', '15'); // new 없이 생성 -> undefined
// console.log(man.getInfo());

const man2 = new Man('김옥녀', '15'); // new 없이 생성 -> undefined
...
function Cat(name, age) {
    ...
    if (!new.target) { //  new 를 이용한 생성자인지 확인하는 조건문
        console.log('동작 확인') // new 사용 x
    }
