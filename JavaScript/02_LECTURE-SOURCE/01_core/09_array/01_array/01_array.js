 ...
 *
 * - 자바스크립트의 모든 값이 객체의 프로퍼티 값이 도리 수 있으므로 모든 값이 배열의 요소가 될 수 있다.
 * - 자바 스크립트의 배열은 인덱스로 배열 요소에 접근하는 경우에는 일반적인 배열보다 느리지만
 *   삽입, 삭제하는 경우에는 일반적인 배열보다 빠르다.
 */
...
const array3 = new Array(10); // 10칸 배열
console.log(array3);

const array4 = new Array(1, 2, 3);
console.log(array4);

console.log(Array.of(10)); // 10을 포함한 배열 (Array.of(a)는 a를 요소로 취급한다.
console.log(Array.of(1, 2, 3));
console.log(Array.of('hi', 'hello World'));
...
console.log(typeof array); // 배열은 Object 타입